...
# Create phiblock user
RUN adduser --system --group --disabled-password phiblock && \
	mkdir -p /wallet /home/phiblock/.bitmonero && \
	chown -R phiblock:phiblock /home/phiblock/.bitmonero && \
	chown -R phiblock:phiblock /wallet

# Contains the blockchain
VOLUME /home/phiblock/.bitmonero
...
# switch to user phiblock
USER phiblock

ENTRYPOINT ["phiblockd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18000", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18001", "--non-interactive", "--confirm-external-bind"]
